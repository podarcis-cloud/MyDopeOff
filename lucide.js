...
window.LUCIDE = (function () {
  ...
  /* Marque texte */
  function wordmark() {
    return '<span style="font-family:var(--disp,Manrope,sans-serif);font-weight:800;letter-spacing:-.02em;color:#0F172A;">MyDope <b style="color:#2563EB;font-weight:800;">Off</b></span>';
  }
  ...
  function renderNav(active) {
    return '<nav class="bottom-nav">' + NAV.map(n =>
      '<a class="bn-item' + (n.k === active ? ' active' : '') + '" href="' + link(n.href) + '">' +
