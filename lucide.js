...
window.LUCIDE = (function () {
  ...
  /* Marque texte : le "O" de Off est remplacé par le glyphe power (anneau + barre) */
  function powerGlyph(em) {
    em = em || 1;
    const s = Math.round(15 * em);
    return '<svg viewBox="0 0 24 24" width="' + s + '" height="' + s + '" style="vertical-align:-0.13em;margin:0 .01em;" aria-hidden="true">' +
      '<path d="M7.3 6.2a8 8 0 1 0 9.4 0" fill="none" stroke="#1D4ED8" stroke-width="2.4" stroke-linecap="round"/>' +
      '<line x1="12" y1="3.2" x2="12" y2="12" stroke="#1D4ED8" stroke-width="2.4" stroke-linecap="round"/>' +
      '</svg>';
  }
  function wordmark() {
    return '<span style="font-family:var(--disp,Manrope,sans-serif);font-weight:800;letter-spacing:-.02em;color:#0F172A;white-space:nowrap;">MyDope ' +
      '<b style="color:#2563EB;font-weight:800;">' + powerGlyph(1.05) + 'ff</b></span>';
  }
  ...
  const NAV = [
    ...
    { k: 'suivi', href: 'suivi.html', label: 'Suivi',
